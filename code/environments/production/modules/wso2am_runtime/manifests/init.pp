...
class wso2am_runtime (
  ...
  #new
  $key_validator          = $wso2am_runtime::params::key_validator,
  $throttling             = $wso2am_runtime::params::throttling,
  $auth_manager           = $wso2am_runtime::params::auth_manager,
  $oauth_configurations   = $wso2am_runtime::params::oauth_configurations,
  $api_store              = $wso2am_runtime::params::api_store,
